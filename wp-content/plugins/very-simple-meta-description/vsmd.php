 ...
 * Description: This is a lightweight plugin to add a meta description to your WordPress website.
 * Version: 6.8
 * Author: Guido
...
function vsmd_meta_description() {
	...
	global $post;
	// get settings
	$vsmd_meta = get_option( 'vsmd-setting' );
	...
	$vsmd_product_cat_tag_description = get_option( 'vsmd-setting-8' );
